...
dynamsoft.dbrEnv.licenseKey = "t0068NQAAACmLs2R7y5C9/Rs9EOtj2UWaA2uKv88AJ7kzayHQWHx2/XOHjuFomclhymp1Os9kROLbYI4lUBmavHqHhDDNrjY=";
...
var loopReadVideo = function () {
    ...
    barcodeReader.updateRuntimeSettings(testRuntimeSettingsReader.getRuntimeSettings()).then(() => {
        ...
        for (let i = 0; i < txtArr.length; ++i) {
            ...
            $.ajax({
                url: "https://api.dabas.com/DABASService/V2/article/gtin/" + gtin + "/JSON?apikey=d2dac13e-e432-4392-8a1c-34cb67dcee69",
                type: "GET",
                ...
                error: function (response) {
                    pTopLog.innerText = "Not found! Try again!";
                    $divTopLog.append(pTopLog);
                    $(pTopLog).slideDown();
